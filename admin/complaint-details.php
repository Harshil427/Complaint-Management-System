										...
										<tbody>
											...
											while ($row = mysqli_fetch_array($query)) {
												...
												<tr>
													...
													<td>
														<?php if ($row['status'] == "closed") {
															...
															<a href="javascript:void(0);"
																onClick="popUpWindow('http://localhost/cms/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']); ?>');"
																title="Update order">
													...
													<td colspan="4">
														<a href="javascript:void(0);"
															onClick="popUpWindow('http://localhost/cms/admin/userprofile.php?uid=<?php echo htmlentities($row['userId']); ?>');"
															title="Update order">
